...
// Project related.
var project                 = 'RedFramework'; // Project Name.
var projectURL              = 'localhost/testwp'; // Project URL. Could be something like localhost:8888.
var productURL              = './'; // Theme/Plugin URL. Leave it like it is, since our gulpfile.js lives in the root folder.

// Translation related.
var text_domain             = 'redvolver'; // Your textdomain here.
var destFile                = 'redvolver.pot'; // Name of the transalation file.
var packageName             = 'redvolver'; // Package name.
...
var jsCustomFile            = 'rvbubble'; // Compiled JS custom file name.
 ...
 */
 ...
 gulp.task( 'translate', function () {
  ...
  gulp.task( 'prodjs', function() {
    ...
    .pipe( lineec() ) // Consistent Line Endings for non UNIX systems.
    .pipe( gulp.dest( jsCustomDestination ) )
    .pipe( notify( { message: 'TASK: "Prodjs" Completed! 💯', onLast: true } ) );
 });
